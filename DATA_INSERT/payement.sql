...
insert into payment (payment_mode, payment_value, id_reservation ) values ('mvola', 25000, 9);
insert into payment (payment_mode, payment_value, id_reservation ) values ('mvola', 60000, 10);
insert into payment (payment_mode, payment_value, id_reservation ) values ('visa', 120100, 5);
insert into payment (payment_mode, payment_value, id_reservation ) values ('visa', 252200, 7);
insert into payment (payment_mode, payment_value, id_reservation ) values ('mastercard', 60000, 6);
insert into payment (payment_mode, payment_value, id_reservation ) values ('mvola', 70000, 8);
insert into payment (payment_mode, payment_value, id_reservation ) values ('mvola', 5000, 9);
insert into payment (payment_mode, payment_value, id_reservation ) values ('mvola', 60000, 10);
insert into payment (payment_mode, payment_value, id_reservation ) values ('mvola', 70000, 10);